...
public class JifenduihuanEntity<T> implements Serializable {
	 ...
	 * 设置：兑换单号
	 */
	public void setDuihuandanhao(String duihuandanhao) {
		this.duihuandanhao = duihuandanhao;
	}
	/**
	 * 获取：兑换单号
	 */
	public String getDuihuandanhao() {
		return duihuandanhao;
	}
	/**
	 * 设置：商品名称
	 */
