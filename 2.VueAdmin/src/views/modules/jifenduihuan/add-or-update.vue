<template>
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"14px","color":"#666","background":"none"}'>
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'" label="兑换单号" prop="duihuandanhao">
					<el-input v-model="ruleForm.duihuandanhao" placeholder="兑换单号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.duihuandanhao" label="兑换单号" prop="duihuandanhao">
					<el-input v-model="ruleForm.duihuandanhao" placeholder="兑换单号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="订单积分" prop="jifen">
					<el-input v-model="jifen" placeholder="订单积分" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.jifen" label="订单积分" prop="jifen">
					<el-input v-model="ruleForm.jifen" placeholder="订单积分" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="date" v-if="type!='info'" label="兑换日期" prop="duihuanriqi">
					<el-date-picker
						format="yyyy 年 MM 月 dd 日"
						value-format="yyyy-MM-dd"
						v-model="ruleForm.duihuanriqi" 
						type="date"
						:readonly="ro.duihuanriqi"
						placeholder="兑换日期"
					></el-date-picker> 
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.duihuanriqi" label="兑换日期" prop="duihuanriqi">
					<el-input v-model="ruleForm.duihuanriqi" placeholder="兑换日期" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="信息备注" prop="xinxibeizhu">
					<el-input  v-model="ruleForm.xinxibeizhu" placeholder="信息备注" clearable  :readonly="ro.xinxibeizhu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="信息备注" prop="xinxibeizhu">
...
export default {
	...
	created() {
		this.ruleForm.duihuanriqi = this.getCurDate()
	},
	methods: {
    ...
    // 提交
    onSubmit() {
		if(this.ruleForm.duihuandanhao) {
			this.ruleForm.duihuandanhao = String(this.ruleForm.duihuandanhao)
		}
	...
	if(this.ruleForm.shangpintupian!=null) {
      ...
      if(parseInt(this.ruleForm.jifen)>parseInt(this.ruleForm.yonghujifen)){
        this.$message.error("订单积分不能超过用户积分");
        return
      }
