<template>
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"14px","color":"#666","background":"none"}'>
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="任务名称" prop="renwumingcheng">
					<el-input  v-model="ruleForm.renwumingcheng" placeholder="任务名称" clearable  :readonly="ro.renwumingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="任务名称" prop="renwumingcheng">
					<el-input v-model="ruleForm.renwumingcheng" placeholder="任务名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="select" v-if="type!='info'"  label="任务分类" prop="renwufenlei">
					<el-select :disabled="ro.renwufenlei" v-model="ruleForm.renwufenlei" placeholder="请选择任务分类" >
						<el-option
							v-for="(item,index) in renwufenleiOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="任务分类" prop="renwufenlei">
					<el-input v-model="ruleForm.renwufenlei"
						placeholder="任务分类" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="upload" v-if="type!='info' && !ro.renwutupian" label="任务图片" prop="renwutupian">
					<file-upload
						tip="点击上传任务图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="upload" v-else-if="ruleForm.renwutupian" label="任务图片" prop="renwutupian">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="任务要求" prop="renwuyaoqiu">
					<el-input  v-model="ruleForm.renwuyaoqiu" placeholder="任务要求" clearable  :readonly="ro.renwuyaoqiu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="任务要求" prop="renwuyaoqiu">
					<el-input v-model="ruleForm.renwuyaoqiu" placeholder="任务要求" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="打卡周期" prop="dakazhouqi">
					<el-input  v-model="ruleForm.dakazhouqi" placeholder="打卡周期" clearable  :readonly="ro.dakazhouqi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="打卡周期" prop="dakazhouqi">
					<el-input v-model="ruleForm.dakazhouqi" placeholder="打卡周期" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-if="type!='info'"  label="任务内容" prop="renwuneirong">
					<editor 
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else-if="ruleForm.renwuneirong" label="任务内容" prop="renwuneirong">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"inherit","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.renwuneirong"></span>
                </el-form-item>
...
export default {
	...
	methods: {
		...
		init(id,type) {
            ...
            this.$http({
				url: `option/renwufenlei/renwufenlei`,
				method: "get"
            }).then(({ data }) => {
				if (data && data.code === 0) {
					this.renwufenleiOptions = data.data;
				} else {
					this.$message.error(data.msg);
				}
            });
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.renwuneirong = this.ruleForm.renwuneirong.replace(reg,'../../../springbootipi25y92/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
