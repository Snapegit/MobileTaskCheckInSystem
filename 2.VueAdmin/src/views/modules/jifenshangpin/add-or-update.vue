	...
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"14px","color":"#666","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="商品数量" prop="shangpinshuliang">
					<el-input  v-model.number="ruleForm.shangpinshuliang" placeholder="商品数量" clearable  :readonly="ro.shangpinshuliang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="商品数量" prop="shangpinshuliang">
					<el-input v-model="ruleForm.shangpinshuliang" placeholder="商品数量" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="商品积分" prop="shangpinjifen">
					<el-input  v-model.number="ruleForm.shangpinjifen" placeholder="商品积分" clearable  :readonly="ro.shangpinjifen"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="商品积分" prop="shangpinjifen">
					<el-input v-model="ruleForm.shangpinjifen" placeholder="商品积分" readonly></el-input>
				</el-form-item>
			</template>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.shangpinxiangqing = this.ruleForm.shangpinxiangqing.replace(reg,'../../../springbootipi25y92/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
