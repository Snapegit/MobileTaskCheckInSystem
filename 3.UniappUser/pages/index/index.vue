	...
	<view :style='{"minHeight":"100vh","padding":"0px","overflow":"hidden","alignItems":"flex-start","flexWrap":"wrap","background":"linear-gradient(0deg, rgba(255,255,255,1) 96%, rgba(34,56,96,1) 98%, rgba(34,56,96,1) 100%),#fff","flexDirection":"row","display":"flex","width":"100%","height":"auto"}'>
		...
		<view class="cu-bar bg-white search" :style='{"padding":"0px","margin":"0 auto 40rpx","borderRadius":"16rpx","background":"none","display":"flex","width":"calc(100% - 48rpx)","height":"auto","order":"-1"}'>
			...
			<view :style='{"margin":"0","flex":"1","position":"relative"}' v-if="queryIndex==0" class="search-form round">
				...
				<input :style='{"border":"0","padding":"12rpx 20rpx 12rpx 80rpx","color":"#333","borderRadius":"16rpx 0 0 16rpx","background":"#fff","width":"100%","lineHeight":"56rpx","fontSize":"28rpx","height":"80rpx"}' v-model="searchForm.renwuxinxirenwumingcheng" type="text" placeholder="任务名称" ></input>
			</view>
			<button :style='{"border":"0","padding":"0px","margin":"0","color":"#fff","borderRadius":"0 16rpx 16rpx 0","background":"#ff6b5a","width":"136rpx","lineHeight":"80rpx","fontSize":"28rpx","height":"80rpx"}' v-if="queryIndex==0" @tap="onPageTap('renwuxinxi')" class="cu-btn shadow-blur round">搜索</button>
		</view>
		...
		<!-- 关于我们 -->
		<view :style='{"padding":"0px","margin":"40rpx 0","borderRadius":"16rpx","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","height":"auto","order":"5"}'>
			<view :style='{"margin":"32rpx 0 20rpx","color":"#223860","textAlign":"center","background":"url(http://codegen.caihongy.cn/20231208/dd4367eb2136483aa23e9dc12954f2df.png) no-repeat center top","width":"100%","lineHeight":"100rpx","fontSize":"32rpx","fontWeight":"600"}'>{{aboutUsDetail.title}}</view>
			<view :style='{"margin":"0 0 20rpx","color":"#fff","textAlign":"center","display":"none","width":"100%","lineHeight":"1.5","fontSize":"32rpx"}'>{{aboutUsDetail.subtitle}}</view>
			<view :style='{"padding":"0px","margin":"0 2% 0 0","borderRadius":"0px","flexWrap":"wrap","background":"#fff","display":"flex","width":"36%","height":"auto","order":"2"}'>
				<img :style='{"width":"100%","margin":"0 0px","objectFit":"cover","display":"block","clipPath":"polygon(10% 0, 100% 0%, 90% 100%, 0% 100%)","height":"268rpx"}' v-if="aboutUsDetail.picture1" :src="baseUrl+aboutUsDetail.picture1">
			...
			<view :style='{"padding":"20rpx 32rpx","margin":"20rpx 0 0px 2%","overflow":"hidden","color":"rgb(102, 102, 102)","borderRadius":"0","background":"linear-gradient(270deg, rgba(246,249,255,1) 0%, rgba(239,244,255,1) 100%),#f1f6ff","clipPath":"polygon(4% 0, 100% 0%, 94% 100%, 0% 100%)","width":"60%","lineHeight":"42rpx","fontSize":"28rpx","textIndent":"2em","height":"268rpx"}' v-html="aboutUsDetail.content"></view>
		...
		<!-- 系统简介 -->
		<view :style='{"padding":"0px","margin":"40rpx 0","borderRadius":"16rpx","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","height":"auto","order":"2"}'>
			<view :style='{"margin":"32rpx 0 0","color":"#223860","textAlign":"center","background":"url(http://codegen.caihongy.cn/20231208/dd4367eb2136483aa23e9dc12954f2df.png) no-repeat center top","width":"100%","lineHeight":"100rpx","fontSize":"32rpx","fontWeight":"600"}'>{{systemIntroductionDetail.title}}</view>
			<view :style='{"margin":"0 0 20rpx","color":"#fff","textAlign":"center","display":"none","width":"100%","lineHeight":"1.5","fontSize":"32rpx"}'>{{systemIntroductionDetail.subtitle}}</view>
			<view :style='{"padding":"0px","margin":"0 1% 0 2%","borderRadius":"0px","flexWrap":"wrap","background":"#fff","display":"flex","width":"34%","justifyContent":"space-between","height":"auto","order":"2"}'>
				<img :style='{"margin":"0 0px","objectFit":"cover","borderRadius":"0px","display":"block","clipPath":"polygon(10% 0, 100% 0%, 90% 100%, 0% 100%)","width":"100%","height":"268rpx"}' v-if="systemIntroductionDetail.picture1" :src="baseUrl+systemIntroductionDetail.picture1">
				<img :style='{"width":"32%","margin":"0 0px","objectFit":"cover","borderRadius":"16rpx","display":"none","height":"160rpx"}' v-if="systemIntroductionDetail.picture2" :src="baseUrl+systemIntroductionDetail.picture2">
			...
			<view :style='{"padding":"20rpx 32rpx","margin":"0 2% 0px 1%","color":"#333","clipPath":"polygon(6% 0, 100% 0%, 94% 100%, 0% 100%)","textIndent":"2em","overflow":"hidden","borderRadius":"0","background":"#f1f6ff","width":"60%","lineHeight":"42rpx","fontSize":"28rpx","height":"268rpx","order":"3"}' v-html="systemIntroductionDetail.content"></view>
		...
		<view class="listBox list" :style='{"width":"100%","margin":"40rpx auto 0","background":"none","order":"3"}'>
			...
			<view class="title" :style='{"padding":"0 24rpx","margin":"0","textAlign":"center","background":"url(http://codegen.caihongy.cn/20231208/dd4367eb2136483aa23e9dc12954f2df.png) no-repeat center top","display":"block","width":"100%","lineHeight":"100rpx","position":"relative","justifyContent":"space-between","height":"96rpx"}'>
				<view :style='{"color":"#223860","fontSize":"32rpx","fontWeight":"600"}'>用户</view>
				<view :style='{"position":"absolute","right":"80rpx","top":"-40rpx","display":"block"}' @tap="onPageTap('yonghu')">
		  ...
		  <view v-if="3 == 3" class="list-box style3" :style='{"width":"100%","padding":"24rpx 24rpx 0","margin":"20rpx 0 0","height":"auto"}'>
			<view @tap="onDetailTap('yonghu',product.id)" v-for="(product,index) in homeyonghulist" :key="index" class="list-item" :style='{"boxShadow":"0 0px 0px rgba(0,0,0,.3)","margin":"0 0 40rpx","alignItems":"center","flexWrap":"wrap","display":"flex","width":"100%","height":"auto"}'>
			  <image :style='{"width":"200rpx","objectFit":"cover","borderRadius":"8rpx","display":"block","clipPath":"polygon(10% 0, 100% 0%, 90% 100%, 0% 100%)","height":"240rpx"}' class="list-item-image" mode="aspectFill" v-if="product.touxiang.substring(0,4)=='http'" :src="product.touxiang"></image>
			  <image :style='{"width":"200rpx","objectFit":"cover","borderRadius":"8rpx","display":"block","clipPath":"polygon(10% 0, 100% 0%, 90% 100%, 0% 100%)","height":"240rpx"}' class="list-item-image" mode="aspectFill" v-else :src="product.touxiang?baseUrl+product.touxiang.split(',')[0]:''"></image>
			  <view class="list-item-body" :style='{"width":"calc(100% - 200rpx)","padding":"12rpx 0 12rpx 20rpx","margin":"0","background":"linear-gradient(30deg, rgba(246,249,255,1) 0%, rgba(239,244,255,1) 100%),#f1f6ff","clipPath":"polygon(4% 0, 100% 0%, 96% 100%, 0% 100%)","height":"240rpx"}'>
				<view :style='{"width":"100%","padding":"0 20rpx","margin":"0","lineHeight":"48rpx","fontSize":"28rpx","color":"#333"}' class="list-item-title">{{product.yonghuming}}</view>
				<view :style='{"width":"100%","padding":"0 20rpx","margin":"0","lineHeight":"48rpx","fontSize":"28rpx","color":"#333"}' class="list-item-title">{{product.xingming}}</view>
		...
		<view class="listBox news" :style='{"width":"100%","margin":"60rpx 0 0","background":"none","order":"1"}'>
			...
			<view class="title" :style='{"padding":"0 24rpx","margin":"40rpx auto","textAlign":"center","background":"url(http://codegen.caihongy.cn/20231208/dd4367eb2136483aa23e9dc12954f2df.png) no-repeat center top","display":"block","width":"100%","lineHeight":"100rpx","position":"relative","justifyContent":"space-between","height":"96rpx"}'>
				<view :style='{"color":"#223860","fontSize":"32rpx","fontWeight":"600"}'>公告通知</view>
	...
	export default {
		...
		methods: {
			...
			async getHomeList(){
				...
				this.homeyonghulist = res.data.list
			...
			queryChange(e) {
				...
				this.searchForm.renwuxinxirenwumingcheng="";
			},
			//轮播图跳转
			onSwiperTap(e) {
				if(e.url) {
			...
			onPageTap(tableName){
				if(this.queryIndex==0) {
					uni.setStorageSync('indexQueryCondition',this.searchForm.renwuxinxirenwumingcheng);
					this.searchForm.renwuxinxirenwumingcheng = '';
				}
